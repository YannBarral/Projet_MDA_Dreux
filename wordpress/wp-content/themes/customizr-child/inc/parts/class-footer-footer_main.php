	    	...
	    	echo apply_filters(
	    		...
	    		sprintf('<div class="%1$s">%2$s</div>',
		    		...
		    		sprintf( '<p>%1$s %2$s %3$s</p>',
                            ...
                            apply_filters( 'tc_credit_link', sprintf( '&middot; Réalisé by la Wild Code School - Yann Baral/Hadrien Buret/Grégory Bizet'<a href="'.TC_WEBSITE.'">Press Customizr</a>' ) ),
                            apply_filters( 'tc_wp_powered', sprintf( '&middot; %1$s <a class="" target="_blank" href="" title="%2$s"></a> &middot;',
